//
//  WithNoteUserTableViewCell.swift
//  PracticalTest
//
...
class WithNoteUserTableViewCell: UITableViewCell {
...
extension WithNoteUserTableViewCell: UserListTableViewCellProtocol {
    func configUserCellData(_ cellData: UserListTableViewCellModelProtocol?) {
        if let cellData = cellData as? WithNoteUserTableViewCellViewModel {
